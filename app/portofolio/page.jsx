...
export default function PortofolioPage() {
  return (
    <div className={styles.pageWrapper}>
      ...
      {/* CTA Section */}
      <AnimatedSection className={styles.ctaSection} id="portfolio-cta" delay={0.2}>
        <div className={styles.ctaContainer}>
          <h2 className={styles.ctaTitle}>
            Tertarik Memiliki Website <span className={styles.titleHighlight}>Luar Biasa</span> Seperti Ini?
          </h2>
          <p className={styles.ctaDesc}>
            Mari diskusikan visi Anda. Kami siap membantu mewujudkan kehadiran digital yang profesional, fungsional, dan mendatangkan hasil nyata untuk bisnis Anda.
          </p>
          <a
            href="https://wa.me/6285163731467" // Ganti dengan nomor yang benar jika ada
            target="_blank"
